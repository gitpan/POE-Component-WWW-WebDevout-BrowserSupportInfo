...
C<event> argument to C<fetch()> event/method will recieve input from
...
Unless an error occured, the C<results> key will contain the output
...
If an error occured during the look up, or no results were returned,
...
Please report any bugs or feature requests to C<bug-poe-component-www-webdevout-browsersupportinfo at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-WWW-WebDevout-BrowserSupportInfo>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc POE::Component::WWW::WebDevout::BrowserSupportInfo
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-WWW-WebDevout-BrowserSupportInfo>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-WWW-WebDevout-BrowserSupportInfo>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-WWW-WebDevout-BrowserSupportInfo>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-WWW-WebDevout-BrowserSupportInfo>
